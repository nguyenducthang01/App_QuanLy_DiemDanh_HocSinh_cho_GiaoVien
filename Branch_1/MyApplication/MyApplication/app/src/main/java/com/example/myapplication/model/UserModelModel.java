...
public class UserModelModel extends AppCompatActivity implements IUserModel {
    ...
    public void checkUserValidity(ILoginView context) {
        ...
        System.out.println("request"+Request.Method.POST);
        // requestQueue.start();
...
//                System.out.println("1");
                if (response.equals("Error")) {
                    ...
                    try {
                        ...
                        if (object != null) {
                            ...
                            Toast.makeText((Context) loginView, "Invalid response from server!", Toast.LENGTH_SHORT).show();
                        }
                    } catch (JSONException e) {
                        e.printStackTrace();
                        Toast.makeText((Context) loginView, "JSON Parsing Error!", Toast.LENGTH_SHORT).show();
                    }
                }
            }
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                System.out.println("getparam"+username+","+password);
                params.put("username", username);
                params.put("password", password);
                System.out.println("🔹 Sending Params: " + params.toString());
                return params;
            }
        };
